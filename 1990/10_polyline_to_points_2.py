...
shp = fiona.open(filepath + "Final_Output/greenland_glacier-water_1990.shp")
...
print('exporting')
out_gdf.to_file(filepath + 'Final_Output/points/1990-greenland_glacier-water_points.shp')
out_gdf_exploded.to_file(filepath + 'Final_Output/points/1990-greenland_glacier-water_points_exploded.shp')
