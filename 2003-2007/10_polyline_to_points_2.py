...
filepath = "C:/Users/theoh/Dropbox (University of Oregon)/Oregon/Glacier/2003/"
shp = fiona.open(filepath + "Final_Output/greenland_glacier-water_2003.shp")
...
print('exporting')
out_gdf.to_file(filepath + 'Final_Output/points/2003-greenland_glacier-water_points.shp')
out_gdf_exploded.to_file(filepath + 'Final_Output/points/2003-greenland_glacier-water_points_exploded.shp')
