...
for file in files:
    ...
    if len(np.unique(water_ice_edges)) > 1:
        ...
        with rasterio.Env():
            ...
            with rasterio.open(f'C:/Users/theoh/Dropbox (University of Oregon)/Oregon/Glacier/2005/Classified/edges/water_ice/water_ice_edges{counter}.tif', 'w', **profile) as dst:
